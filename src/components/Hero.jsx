                            ...
                            <span>
                                <div className="relative inline-block">
                                    ...
                                    <svg
                                        ...
                                        <path d="M168.73 88.4545C212.374 83.5416 256.673 76.6038 286.744 70.1763C515.332 21.3168 98.4365 -37.5639 7.34247 34.9736C-23.6897 59.6843 63.7908 80.3409 168.73 88.4545ZM168.73 88.4545C95.8766 96.6551 24.8448 101 24.8448 101M168.73 88.4545C233.806 93.486 305.596 93.0784 360 87.6841" stroke="#2BB32A" strokeWidth="2" strokeLinecap="square" />
                                    </svg>
                                </div>
                            </span> You</h1>
